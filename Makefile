...
online_viewer: online_viewer.cpp read_newest raw_image_tools raw_image_reader single_image_reader.cpp
	g++ -o online_viewer online_viewer.cpp read_newest.cpp rootstyle.cpp raw_image_reader.o raw_image_tools.o $(CFLAGS) $(LDFLAGS) $(BOOST_LIBS) $(INC_STYLE)
...
single_image_reader: raw_image_tools raw_image_reader single_image_reader.cpp
	g++ -o single_image_reader single_image_reader.cpp rootstyle.cpp raw_image_reader.o raw_image_tools.o $(CFLAGS) $(LDFLAGS) $(BOOST_LIBS) $(INC_STYLE)
