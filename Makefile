...
read_newest: raw_image_tools raw_image_reader single_image_reader.cpp
	g++ -c read_newest.cpp rootstyle.cpp raw_image_reader.cpp raw_image_tools.cpp $(CFLAGS) $(LDFLAGS) $(BOOST_LIBS) 

single_image_reader: raw_image_tools raw_image_reader single_image_reader.cpp
	g++ -o single_image_reader single_image_reader.cpp rootstyle.cpp raw_image_reader.cpp raw_image_tools.cpp $(CFLAGS) $(LDFLAGS) $(BOOST_LIBS) 

raw_image_reader: raw_image_reader.cpp raw_image_reader.h raw_image_tools 
	g++ -c raw_image_reader.cpp raw_image_tools.cpp rootstyle.cpp $(CFLAGS) $(LDFLAGS) $(BOOST_LIBS) 
